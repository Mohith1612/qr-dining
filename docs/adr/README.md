...
| [0004](0004-typed-response-boundaries.md) | Proposed: type high-risk response boundaries incrementally | 2026-09-14 | Inventory: 97 of 157 `c.JSON` calls pass `gin.H`; standardized errors already use `APIError` (`backend/internal/handlers/errors.go:9-21,99-118`). |
